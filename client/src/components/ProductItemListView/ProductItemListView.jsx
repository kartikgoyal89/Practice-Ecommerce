...
function ProductItemListView() {
  ...
  return (
    <div className="productItemList p-3 border-2 rounded-md flex gap-3">
      <div className="group imgWrapper w-[23%] overflow-hidden relative">
        <Link to="/">
      ...
      <div className="info p-3 w-[75%]">
        ...
        <Button className="!bg-primary !text-white !mt-3 !flex !items-center !gap-2">
          {" "}
